...
if ($ward_no != NULL){
	...
	$query= "SELECT	* FROM Patient p, PatientAllocation pa WHERE	p.PatientNumber = pa.PatientNumber AND ActualLeave = '0000-00-00 00:00:00' AND pa.wardNo =".$ward_no;
} else {
...
while($row = mysql_fetch_array($result)) {
	echo "<tr>
					<td style='widh:4px;'>".$row['PatientNumber']."</td>
